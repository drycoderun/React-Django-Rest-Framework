...
total_day = 360 #total days back
commit_frequency = 3 #commit time per day
pointer = 0
# for repo in repos:
repo_link = "https://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@github.com/drycoderun/React-Django-Rest-Framework.git"
...
f = open("commit.txt", "w")
os.system("git config user.name \"drycoderun\"")
os.system("git config user.email miljancor.work@gmail.com")
os.system("git init")
